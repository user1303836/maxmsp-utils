			...
			},
			{
				"box": {
					...
					"patcher": {
						...
						"enablevscroll": 1,
						"devicewidth": 0.0,
						"description": "Converts pitch+gate signals to MIDI via sample-accurate edge detection",
						"digest": "",
						"tags": "",
						"style": "",
						"subpatcher_template": "",
						...
						"boxes": [
							{
								"box": {
									...
									"maxclass": "inlet",
									"index": 1,
									"comment": "Pitch signal (step function from stepfun~)",
									"numinlets": 0,
									"numoutlets": 1,
									"outlettype": [
										"signal"
							...
							},
							{
								"box": {
									...
									"maxclass": "inlet",
									"index": 2,
									"comment": "Gate signal (0/1 from GateGen)",
									"numinlets": 0,
									"numoutlets": 1,
									"outlettype": [
										"signal"
										...
										"boxes": [
											...
											},
											{
												"box": {
													...
													"code": "// Sample-accurate note edge detector\n// in1 = pitch signal (from stepfun~)\n// in2 = gate signal (0/1 from GateGen)\n// out1 = note-on trigger (gate rise OR pitch change during gate)\n// out2 = note-off trigger (gate fall only)\n// out3 = held pitch (latched at trigger moments)\n\nHistory prev_gate(0);\nHistory prev_pitch(0);\nHistory held_pitch(60);\n\npitch = in1;\ngate = in2 >= 0.5;\n\nnote_on = 0;\nnote_off = 0;\n\nif (gate && !prev_gate) {\n    note_on = 1;\n    held_pitch = pitch;\n}\nif (!gate && prev_gate) {\n    note_off = 1;\n}\nif (gate && prev_gate && (pitch != prev_pitch)) {\n    note_on = 1;\n    held_pitch = pitch;\n}\n\nprev_gate = gate;\nprev_pitch = pitch;\n\nout1 = note_on;\nout2 = note_off;\nout3 = held_pitch;"
												}
											},
											{
												"box": {
