{
	"patcher": {
		...
		"boxes": [
				...
				"box": {
					...
					"patcher": {
						...
						"boxes": [
							...
							{ "box": { "id": "obj-3", "maxclass": "inlet", "index": 3, "comment": "Velocity (int)", "numinlets": 0, "numoutlets": 1, "outlettype": [""], "patching_rect": [270.0, 30.0, 30.0, 30.0] } },
							{ "box": { "id": "obj-4", "maxclass": "inlet", "index": 4, "comment": "MIDI channel (int)", "numinlets": 0, "numoutlets": 1, "outlettype": [""], "patching_rect": [390.0, 30.0, 30.0, 30.0] } },
							{ "box": { "id": "obj-5", "maxclass": "inlet", "index": 5, "comment": "MIDI thru (raw)", "numinlets": 0, "numoutlets": 1, "outlettype": ["int"], "patching_rect": [510.0, 30.0, 30.0, 30.0] } },
							{
								"box": {
									"id": "obj-10", "maxclass": "newobj", "text": "gen~ @title NoteEdge", "numinlets": 2, "numoutlets": 3, "outlettype": ["signal", "signal", "signal"],
							...
							{ "box": { "id": "obj-20", "maxclass": "newobj", "text": "snapshot~ 20", "numinlets": 2, "numoutlets": 1, "outlettype": ["float"], "patching_rect": [30.0, 130.0, 75.0, 22.0] } },
							{ "box": { "id": "obj-21", "maxclass": "newobj", "text": "snapshot~ 20", "numinlets": 2, "numoutlets": 1, "outlettype": ["float"], "patching_rect": [150.0, 130.0, 75.0, 22.0] } },
							...
							{ "box": { "id": "obj-30", "maxclass": "newobj", "text": "pack 0 0 0", "numinlets": 3, "numoutlets": 1, "outlettype": [""], "patching_rect": [30.0, 250.0, 120.0, 22.0] } },
							{ "box": { "id": "obj-31", "maxclass": "newobj", "text": "pack 0 0 0", "numinlets": 3, "numoutlets": 1, "outlettype": [""], "patching_rect": [150.0, 250.0, 120.0, 22.0] } },
							{ "box": { "id": "obj-32", "maxclass": "newobj", "text": "schedule", "numinlets": 1, "numoutlets": 1, "outlettype": [""], "patching_rect": [30.0, 280.0, 55.0, 22.0] } },
							{ "box": { "id": "obj-33", "maxclass": "newobj", "text": "schedule", "numinlets": 1, "numoutlets": 1, "outlettype": [""], "patching_rect": [150.0, 280.0, 55.0, 22.0] } },
							{ "box": { "id": "obj-34", "maxclass": "newobj", "text": "midiformat", "numinlets": 7, "numoutlets": 1, "outlettype": ["int"], "patching_rect": [30.0, 320.0, 100.0, 22.0] } },
							{ "box": { "id": "obj-35", "maxclass": "newobj", "text": "midiformat", "numinlets": 7, "numoutlets": 1, "outlettype": ["int"], "patching_rect": [150.0, 320.0, 100.0, 22.0] } },
			...
			},
			{
				"box": {
					...
					"patcher": {
						...
						"toolbars_unpinned_last_save": 0, "tallnewobj": 0, "boxanimatetime": 200,
						"enablehscroll": 1, "enablevscroll": 1, "devicewidth": 0.0,
						"description": "Sends all-notes-off when transport stops", "digest": "", "tags": "", "style": "", "subpatcher_template": "", "assistshowspatchername": 0,
						"boxes": [
							...
							{ "box": { "id": "obj-5", "maxclass": "newobj", "text": "flush", "numinlets": 1, "numoutlets": 2, "outlettype": ["int", "int"], "patching_rect": [30.0, 180.0, 36.0, 22.0] } },
							{ "box": { "id": "obj-6", "maxclass": "newobj", "text": "midiformat", "numinlets": 7, "numoutlets": 1, "outlettype": ["int"], "patching_rect": [30.0, 210.0, 100.0, 22.0] } },
							{ "box": { "id": "obj-7", "maxclass": "outlet", "index": 1, "comment": "MIDI flush output", "numinlets": 1, "numoutlets": 0, "patching_rect": [30.0, 250.0, 30.0, 30.0] } }
						],
						"lines": [
			...
			{
				"box": { "id": "obj-108", "maxclass": "newobj", "text": "pack 0. 0. 0. 0. 0. 0. 0. 0.", "numinlets": 8, "numoutlets": 1, "outlettype": [""], "patching_rect": [16.0, 560.0, 376.0, 20.0] }
			},
			{
